        ...
        var Renderer = Class.extend({
            ...
            drawEntity: function (entity) {
                ...
                if (HPBar.isMob(entity.kind) && !entity.isDead && !(this.mobile || this.tablet)) {
                    var namex = (entity.x + 8) * this.scale;
                    var namey = (entity.y - 15) * this.scale;
                    // console.log(HPBar.getMobName(entity.kind), entity.x, entity.y, entity.sprite.height);
                    HPBar.drawMobName(this, entity.kind, namex, namey, '#eeddbb');
                    if (entity.hpmax && entity.hpnow) {
                        var hpx = namex;
                        var hpy = (namey / this.scale - 10) * this.scale;
                        HPBar.drawMobHp(this, entity.hpmax, entity.hpnow, hpx, hpy, '#df1f20');
                    }
                }
            },
